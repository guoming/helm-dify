...
ALIYUN_OSS_ACCESS_KEY: {{ .Values.externalAliyunOSS.accessKey | b64enc | quote}}
ALIYUN_OSS_SECRET_KEY: {{ .Values.externalAliyunOSS.secretKey | b64enc | quote}}
...
ANALYTICDB_ACCOUNT: {{ .Values.externalAnalyticDB.account | b64enc | quote }}
ANALYTICDB_PASSWORD: {{ .Values.externalAnalyticDB.accountPassword | b64enc | quote }}
ANALYTICDB_NAMESPACE: {{ .Values.externalAnalyticDB.namespace | b64enc | quote }}
{{- $mode := .Values.externalAnalyticDB.mode | default "openapi" }}
{{- if eq $mode "openapi"}}
ANALYTICDB_KEY_ID: {{ .Values.externalAnalyticDB.accessKey | b64enc | quote}}
ANALYTICDB_KEY_SECRET: {{ .Values.externalAnalyticDB.secretKey | b64enc | quote }}
ANALYTICDB_NAMESPACE_PASSWORD: {{ .Values.externalAnalyticDB.namespacePassword | b64enc | quote }}
{{- end }}
...
PGVECTOR_USER: {{ .Values.externalPgvector.user | b64enc | quote }}
