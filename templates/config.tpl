...
{{- if .Values.externalAliyunOSS.enabled}}
# The type of storage to use for storing user files. Supported values are `local` and `aliyun-oss` and `s3` and `azure-blob`, Default: `local`
STORAGE_TYPE: aliyun-oss
ALIYUN_OSS_BUCKET_NAME: {{ .Values.externalAliyunOSS.bucketName | quote}}
# ALIYUN_OSS_ACCESS_KEY: {{ .Values.externalAliyunOSS.accessKey }}
# ALIYUN_OSS_SECRET_KEY: {{ .Values.externalAliyunOSS.secretKey }}
ALIYUN_OSS_ENDPOINT: {{ .Values.externalAliyunOSS.endpoint | quote}}
ALIYUN_OSS_REGION: {{ .Values.externalAliyunOSS.region }}
ALIYUN_OSS_AUTH_VERSION: {{ .Values.externalAliyunOSS.authVersion }}
ALIYUN_OSS_PATH: {{ .Values.externalAliyunOSS.path | quote}}
...
REDIS_DB: {{ .dbNumber | default "0" | toString | quote}}
  {{- end }}
...
{{- else if .Values.externalAnalyticDB.enabled}}
{{- $mode := .Values.externalAnalyticDB.mode | default "openapi"}}
# AnalyticDB configuration Only available when VECTOR_STORE is `analyticdb`.
VECTOR_STORE: analyticdb
{{- if eq $mode "openapi" }}
# The AnalyticDB key id.
# ANALYTICDB_KEY_ID: {{ .Values.externalAnalyticDB.accessKey | quote }}
# The AnalyticDB key secret.
# ANALYTICDB_KEY_SECRET: {{ .Values.externalAnalyticDB.secretKey | quote }}
# The AnalyticDB account.
# ANALYTICDB_ACCOUNT: {{ .Values.externalAnalyticDB.account | quote }}
# The AnalyticDB account password.
# ANALYTICDB_PASSWORD: {{ .Values.externalAnalyticDB.accountPassword | quote }}
# The AnalyticDB namespace.
# ANALYTICDB_NAMESPACE: {{ .Values.externalAnalyticDB.namespace | quote }}
# The AnalyticDB password specified in the namespace.
# ANALYTICDB_NAMESPACE_PASSWORD: {{ .Values.externalAnalyticDB.namespacePassword | quote }}
# The AnalyticDB region.
ANALYTICDB_REGION_ID: {{ .Values.externalAnalyticDB.region | quote }}
# The AnalyticDB instance id.
ANALYTICDB_INSTANCE_ID: {{ .Values.externalAnalyticDB.instanceId | quote }}
{{- else if eq $mode "sql" }}
ANALYTICDB_HOST: {{ .Values.externalAnalyticDB.host | quote }}
ANALYTICDB_PORT: {{ .Values.externalAnalyticDB.port | quote }}
ANALYTICDB_MIN_COLLECTION: {{ .Values.externalAnalyticDB.minConn | quote }}
ANALYTICDB_MAX_COLLECTION: {{ .Values.externalAnalyticDB.maxConn | quote }}
{{- end}}
...
MILVUS_DATABASE: {{ .Values.externalMilvus.dbName | default "default" }}
# The milvus username.
...
# The pgvector host.
PGVECTOR_HOST: {{ .Values.externalPgvector.host | quote }}
# The pgvector port.
PGVECTOR_PORT: {{ .Values.externalPgvector.port | toString | quote }}
# The pgvector database.
PGVECTOR_DATABASE: {{ .Values.externalPgvector.dbName | quote }}
# The pgvector username.
# PGVECTOR_USER: {{ .Values.externalPgvector.user | quote }}
# The pgvector password.
# PGVECTOR_PASSWORD: {{ .Values.externalPgvector.password | quote }}
